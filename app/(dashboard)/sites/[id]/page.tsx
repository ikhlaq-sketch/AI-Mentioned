...
export default async function SiteDetailPage({ params }: { params: { id: string } }) {
  ...
  if (error || !site) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/sites" className="text-emerald-600 hover:text-emerald-700 font-medium mt-2 inline-block">← Back to Sites</Link>
      </div>
    );
  }
  ...
  return (
    <div className="p-6">
      <Link href="/sites" className="text-emerald-600 hover:text-emerald-700 font-medium text-sm mb-4 inline-block">← Back to Sites</Link>
