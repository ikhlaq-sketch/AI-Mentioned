    ...
    <div className="min-h-screen bg-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          {[
            { title: '1. Acceptance of Terms', content: 'By accessing or using Sightura ("the Service"), you agree to be bound by these Terms of Service. Sightura is owned and operated by AK Systems.' },
            { title: '2. Description of Service', content: 'Sightura is an AI Search Visibility platform that monitors how AI chatbots (ChatGPT, Gemini, Claude, Perplexity) mention your brand, analyzes competitor visibility, and generates optimization recommendations.' },
            ...
            { title: '7. Intellectual Property', content: 'You retain all rights to your content. The Sightura platform is owned by AK Systems and protected by copyright laws.' },
