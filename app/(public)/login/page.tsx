      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl shadow-gray-100">
          ...
          <button
            ...
            className="w-full border-2 border-gray-200 hover:border-emerald-300 py-3 rounded-xl text-gray-700 font-semibold flex items-center justify-center gap-2 transition-all hover:bg-gray-50"
          >
