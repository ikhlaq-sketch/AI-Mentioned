    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl shadow-gray-100">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <Link href="/auth/reset-password" className="text-xs text-emerald-600 hover:text-emerald-700 font-medium transition">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-emerald-600 hover:bg-emerald-700 py-3 rounded-xl text-white font-semibold flex justify-center items-center gap-2 transition-all shadow-lg shadow-emerald-200 hover:shadow-xl hover:shadow-emerald-300 disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <button
            ...
            disabled={loading}
            className="w-full border-2 border-gray-200 hover:border-emerald-300 py-3 rounded-xl text-gray-700 font-semibold flex items-center justify-center gap-2 transition-all hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/register" className="text-emerald-600 font-semibold hover:text-emerald-700 transition">Sign up</Link>
          </p>
        </div>
      </div>
      ...
      {loading && (
        <div className="fixed inset-0 z-50 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center">
          <LoadingSpinner size={48} className="text-emerald-600" />
          <p className="mt-4 text-lg font-medium text-[#0f172a]">Signing in…</p>
